      ...
      <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="max-w-full mx-auto bg-[#EAEFF8] shadow-lg rounded-lg p-6 flex flex-col md:flex-row">
            {/* Image Section */}
            <div className="w-[420px] h-[280px] bg-gray-200 rounded-md shadow-lg mb-4 md:mb-0 md:ml-6 order-1 md:order-2">
              {imageUrl ? (
                <img
                  src={imageUrl}
                  alt="Course Image"
            ...
            <form
              action={postCourse}
              className="flex-1 space-y-4 relative order-2 md:order-1"
            >
              {/* Image URL */}
