    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            />
            <div className="p-4">
                    <h3 className="text-xl font-bold text-gray-800">Name_course</h3>
                    <div className="flex justify-2 items-center text-m space-x-2  ">
                    <p className="text-sm text-gray-500">Name_teacher</p>
                    <p className="text-sm text-gray-500">/</p>
                    <p className="text-sm text-gray-500">Name_user</p>
                    </div>
                    <p className="text-sm text-gray-500">Subject</p>
                    <p className="text-sm text-gray-500">location</p>
                    <div className="flex justify-between items-center mt-1">
                        <p className="text-sm text-gray-500">Total_person</p>
                        <p className="text-lg text-green-600 font-semibold">price_per_person</p>
                    </div>
            </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <img
              src="https://via.placeholder.com/100"
              alt="สอนพูดภาษาอังกฤษ"
              className="w-full h-48 object-cover"
            />
            <div className="p-4">
                  <h3 className="text-xl font-bold text-gray-800">สอนพูดภาษาอังกฤษเบื้องต้น</h3>
                      <div className="flex justify-2 items-center text-m space-x-2  ">
                        <p className="text-sm text-gray-500">Name_teacher</p>
                        <p className="text-sm text-gray-500">/</p>
                        <p className="text-sm text-gray-500">Name_user</p>
                      ...
                      <p className="text-sm text-gray-500">location</p>
                      <div className="flex justify-between items-center mt-1">
                        <p className="text-sm text-gray-500">จำนวนคน: 3 / 3 คน</p>
                        <p className="text-lg text-green-600 font-semibold">400 บาท / คน</p>
                    </div>
            </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <img
                src="https://via.placeholder.com/100"
                alt="เขียนโปรแกรม Python"
                className="w-full h-48 object-cover"
            />
            <div className="p-4">
                  <h3 className="text-xl font-bold text-gray-800">เขียนโปรแกรม Python เบื้องต้น</h3>
                      <div className="flex justify-2 items-center text-m space-x-2  ">
                        <p className="text-sm text-gray-500">Name_teacher</p>
                        <p className="text-sm text-gray-500">/</p>
                        <p className="text-sm text-gray-500">Name_user</p>
                      ...
                      <p className="text-sm text-gray-500">location</p>
                    <div className="flex justify-between items-center mt-1">
                        <p className="text-sm text-gray-500">จำนวนคน: 2 / 3 คน</p>
                        <p className="text-lg text-green-600 font-semibold">500 บาท / คน</p>
                    </div>
            </div>
        </div>
      </div>
